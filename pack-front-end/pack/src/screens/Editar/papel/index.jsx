        ...
        <div className={classes.buttons}>
          <div className={classes.buttons}>
            <Button
              ...
              onClick={() =>
                setShowListaIcones((showListaIcones) => !showListaIcones)
              }
            >
              {showListaIcones
                ? "fechar lista de icones"
                : "escolha o icone do seu time"}
            </Button>
            <div>
              {showListaIcones && (
            ...
            <div className={classes.buttons}>
              ...
              {showPrimaryColorPicker && (
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <SketchPicker
                    color={primaryColor}
                    onChange={(updatedPrimaryColor) =>
                      setPrimaryColor(updatedPrimaryColor.hex)
                    }
                  />
                </div>
              )}
              ...
              {showSecondaryColorPicker && (
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <SketchPicker
                    ...
                    onChange={(updatedSecondaryColor) =>
                      setSecondaryColor(updatedSecondaryColor.hex)
                    }
                  />
                </div>
              )}
