...
import { Fade, Fab, Backdrop, Modal, makeStyles } from "@material-ui/core";
...
function Edit({ openModalCargo, setOpenModalCargo, apiUsuario }) {
	const context = useContext(UserContext);
	const [, setImagem] = useState(null);
	const [, setCaminho] = useState(null);
